...
import hufs.cse.Midi.read.PianoRollViewParser.UnfinishedNotesException;
...
//unmatched_note_off _ I modified this**************************
...
*/
			//sb.append(track + "," + startTick + "," + durationTick + "," + note + "," + noteStr.toString());
			sb.append(track + "," + startTick + "," + durationTick + "," + note);
			return sb.toString();
		}
